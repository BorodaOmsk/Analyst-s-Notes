...
Применение: **JAML - DevOps, описание OPEN API**
...
Применение:  **JSON - формат для  REST API по умолчанию, простые структуры(таблицы, вложенные сущности)**
...
Применение: **XML - SOAP, Сложные структуры данных, которые нужно подробно описать и  верифицировать на входе.**
